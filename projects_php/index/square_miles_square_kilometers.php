		...
		<div id="left">
			...
			<section>
				<div style="font-size:20px;font-family: helvetica;">
					<b style="font-size: 25px;">Từ</b>: Square miles  --<i class="fa fa-angle-right"></i> Square kilometers 
				</div>
			</section><br>
			<section>
				<form method="post">
				<input type="number" name="square_miles" required="" min="0" value="1" style="width: 70%;height: 30px;">
				<input type="submit" value="Đổi" required="" style="height: 33px;width: 15%; margin-left: 20px;">
				</form>
			</section><br><br>
			<?php 
				if(isset($_POST['square_miles'])){
					$square_miles = $_POST['square_miles'];
					$square_kilometers = $square_miles * 2.58998811;
					echo "<strong style ='font-size: 20px'> $square_miles square miles = $square_kilometers square kilometers </strong> "; 
				}
 			?>
