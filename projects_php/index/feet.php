...
<body>
	...
	<div id="main" class="row">
		<div id="left">
			<h1><i class="fa fa-money"></i> Chuyển đổi âm lượng</h1><br>
			<section>
				<div style="font-size:20px;font-family: helvetica;">
					<b style="font-size: 25px;">Từ</b>: Cubic Feet  --<i class="fa fa-angle-right"></i> Cubic Meters 
				</div>
			</section><br>
			<section>
				<form method="post">
				<input type="number" name="convert-value" required="" min="0" value="1" style="width: 70%;height: 30px;">
				<input type="submit" value="Đổi" required="" style="height: 33px;width: 15%; margin-left: 20px;">
				</form>
			</section><br><br>
			<?php
				if(isset($_POST['convert-value'])):
				$a = $_POST['convert-value'];
				$p = $a *  0.02831685;
				echo "<strong style ='font-size: 20px'>$a Cubic Feet = $p Cubic Meters</strong>";
			?>
 			<?php endif; ?> 			
 			<section style="margin-top: 25%;">
 				<div style="font-size: 20px; font-family: arial;">
 					Chuyển đổi giữa các đơn vị <span style="text-decoration: underline; font-family: bold; font-size: 21px;">Âm lượng</span> bằng cách sử dụng máy tính trực tuyến của chúng tôi.<br> Nhập bất kỳ đơn vị nào bạn muốn chuyển đổi và nhấn nút Đổi.
 				</div>
 			</section>
 			<section style="margin-top: 5%;">
	 			<div class="list">
	 				<a style="display: block; width: 100%;" href="volume.php">Fluid ounces --<i class="fa fa-angle-right"></i> Millimeters </a>
	 			</div><br>
	 			<div class="list">
					<a style="display: block; width: 100%;" href="gallons.php">Gallons --<i class="fa fa-angle-right"></i>  Liters</a>
	 			</div><br>
	 			<div class="list">
					<a style="display: block; width: 100%;" href="yards.php">Cubic Yards --<i class="fa fa-angle-right"></i> Cubic Meters</a>
	 			</div>
	 			<h1>Bảng ví dụ chuyển đổi</h1><br>
	 			<table border="1">
	 				<tr>
	 					<th rowspan="4" style="width: 130px;height: 80px">Âm lượng</th>
	 					<td style="width: 500px;height: 40px; text-align: center;">1 Fluid ounces = 29.5735296 Millimeters</td>
	 				</tr>
   					<tr>
   						<td style="width: 500px;height: 40px;text-align: center;">1 Gallons = 3.78541178 Liters</td>
   					</tr>
	 				<tr>
   						<td style="width: 500px;height: 40px;text-align: center;">1 Cubic Feet = 0.02831685 Cubic Meters</td>
   					</tr>
   					<tr>
   						<td style="width: 500px;height: 40px;text-align: center;">1 Cubic Yards =  0.764554858 Cubic Meters</td>
   					</tr>
	 			</table>
 			</section>
		</div>q
