		...
		<div id="left">
			...
			<section>
				<div style="font-size:20px;font-family: helvetica;">
					<b style="font-size: 25px;">Từ</b>: Yards  --<i class="fa fa-angle-right"></i> Meters
				</div>
			</section><br>
			<section>
				<form method="post">
				<input type="number" name="yards" required="" min="0" value="1" style="width: 70%;height: 30px;">
			...
			if(isset($_POST['yards'])){
				$yards = $_POST['yards'];
				$meters = $yards * 0.9144;
				echo "<strong style ='font-size: 20px'> $yards yards = $meters meters </strong> ";
			}
 			?>
