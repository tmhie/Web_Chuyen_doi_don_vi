		...
		<div id="left">
			...
			<section>
				<div style="font-size:20px;font-family: helvetica;">
					<b style="font-size: 25px;">Từ</b>: Square inches  --<i class="fa fa-angle-right"></i> Square millimeters 
				</div>
			</section><br>
			<section>
				<form method="post">
				<input type="number" name="square_inches" required="" min="0" value="1" style="width: 70%;height: 30px;">
				<input type="submit" value="Đổi" required="" style="height: 33px;width: 15%; margin-left: 20px;">
				</form>
			</section><br><br>
			<?php 
			if(isset($_POST['square_inches'])){
				$square_inches = $_POST['square_inches'];
				$square_millimeters = $square_inches * 0.0015500;
				echo "<strong style ='font-size: 20px'> $square_inches square inches = $square_millimeters square millimeters </strong> ";
			}
 			?>
 			...
 			<section style="margin-top: 5%;">
	 			...
	 			<div class="list">
					<a style="display: block; width: 100%;" href="square_yards_square_meters.php">Square yards --<i class="fa fa-angle-right"></i>  Square meters</a>
	 			</div><br>
	 			<div class="list">
