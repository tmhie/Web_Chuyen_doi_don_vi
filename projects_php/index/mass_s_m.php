		...
		<div id="left">
			...
			<section>
				<div style="font-size:20px;font-family: helvetica;">
					<b style="font-size: 25px;">Từ</b>: Short tons (tM)  --<i class="fa fa-angle-right"></i> Mega gram (t)
				</div>
			</section><br>
			<section>
				<form method="post">
			...
			<?php 
				...
				$Megagram = $Shorttons / 1.10231;
				echo "<strong style ='font-size: 20px'> $Shorttons Short tons = $Megagram Mega gram </strong> ";
 			?>
 			<?php endif; ?> 			
 			...
 			<section style="margin-top: 5%;"> 						
	 			<div class="list">
					<a style="display: block; width: 100%;" href="mass_s_mt.php">Short tons (tM) --<i class="fa fa-angle-right"></i> Metric ton (mt)</a>
	 			</div><br>
	 			<div class="list">
