		...
		<div id="left">
			...
			<section>
				<div style="font-size:20px;font-family: helvetica;">
					<b style="font-size: 25px;">Từ</b>: Feet  --<i class="fa fa-angle-right"></i> Meters 
				</div>
			</section><br>
			<section>
				<form method="post">
				<input type="number" name="feet" required="" min="0" value="1" style="width: 70%;height: 30px;">
			...
			<?php
				if(isset($_POST['feet'])){
					$feet = $_POST['feet'];
					$meters = $feet * 3.2808;
					echo "<strong style ='font-size: 20px'> $feet feet = $meters meters </strong> ";
				}
 			?>
