		...
		<div id="left">
			...
			<section>
				<div style="font-size:20px;font-family: helvetica;">
					<b style="font-size: 25px;">Từ</b>: GBP (Bảng Anh)  --<i class="fa fa-angle-right"></i> USD (Đô la Mỹ) 
				</div>
			</section><br>
			<section>
				<form method="post">
				<input type="number" name="GBP" required="" min="0" value="1" style="width: 70%;height: 30px;">
			...
			<?php 
				...
				$GBP = $_POST['GBP'];
				$USD = $GBP * 1.3086;
				echo "<strong style ='font-size: 20px'> $GBP GBP = $USD USD </strong> ";
 			?>
 			<?php endif; ?> 			
