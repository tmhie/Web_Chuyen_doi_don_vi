...
<body>
	...
	<div id="main" class="row">
		<div id="left">
			<h1><i class="fa fa-database"></i> Chuyển đổi khối lượng</h1><br>
			<section>
				<div style="font-size:20px;font-family: helvetica;">
					<b style="font-size: 25px;">Từ</b>: Short tons (tM)  --<i class="fa fa-angle-right"></i> Metric ton (mt)
				</div>
			</section><br>
			<section>
				<form method="post">
				<input type="number" name="Shorttons" required="" min="0" value="1" style="width: 70%;height: 30px;">
				<input type="submit" value="Đổi" required="" style="height: 33px;width: 15%; margin-left: 20px;">
				</form>
			</section><br><br>
			<?php 
				if(isset($_POST['Shorttons'])):
				$Shorttons = $_POST['Shorttons'];
				$Metricton = $Shorttons / 1.1023;
				echo "<strong style ='font-size: 20px'> $Shorttons Short tons = $Metricton Metric ton</strong> ";
 			?>
 			<?php endif; ?> 			
 			<section style="margin-top: 25%;">
 				<div style="font-size: 20px; font-family: arial;">
 					Chuyển đổi giữa các đơn vị <span style="text-decoration: underline; font-family: bold; font-size: 21px;">Khối lượng</span> bằng cách sử dụng máy tính trực tuyến của chúng tôi.<br> Nhập bất kỳ đơn vị nào bạn muốn chuyển đổi và nhấn nút Đổi.
 				</div>
 			</section>
 			<section style="margin-top: 5%;"> 								
	 			<div class="list">
	 				<a style="display: block; width: 100%;" href="mass.php">Ounces (oz) --<i class="fa fa-angle-right"></i> Grams (g)</a>
	 			</div><br>
	 			<div class="list">
					<a style="display: block; width: 100%;" href="mass_p_k.php">Pounds (lb) --<i class="fa fa-angle-right"></i> Kilograms (kg)</a>
	 			</div><br>
	 			<div class="list">
					<a style="display: block; width: 100%;" href="mass_s_m.php">Short tons (tM) --<i class="fa fa-angle-right"></i> Mega gram (t)</a>
	 			</div>
	 			<h1>Bảng ví dụ chuyển đổi</h1><br>
	 			<table border="1">
	 				<tr>
	 					<th rowspan="4" style="width: 130px;height: 80px">Khối lượng</th>
	 					<td style="width: 500px;height: 40px; text-align: center;">1 Metric ton (mt) = 1000 Kilograms (kg)</td>
	 				</tr>
	 				<tr>
   						<td style="width: 500px;height: 40px;text-align: center;">1 Short tons (tM) = 907 Kilograms (kg)</td>
   					</tr>
   					<tr>
   						<td style="width: 500px;height: 40px;text-align: center;">1 Long tons (lgM) = 1016 Kilograms (kg)</td>
   					</tr>
   					<tr>
   						<td style="width: 500px;height: 40px;text-align: center;">1 Pounds (lb) = 0.4536 Kilograms (kg)</td>
   					</tr>
	 			</table>
 			</section>
		</div>
