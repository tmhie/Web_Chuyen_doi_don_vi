		...
		<div id="left">
			...
			<section>
				<div style="font-size:20px;font-family: helvetica;">
					<b style="font-size: 25px;">Từ</b>: Fahrenheit (°F)  --<i class="fa fa-angle-right"></i> Celsius (°C) 
				</div>
			</section><br>
			<section>
				<form method="post">
				<input type="number" name="Fahrenheit" required="" min="0" value="1" style="width: 70%;height: 30px;">
			...
			<?php 
				...
				echo "<strong style ='font-size: 20px;font-weight: 700;'> $Fahrenheit Fahrenheit = $Celsius Celsius </strong> ";
 			?>
 			<?php endif; ?>
 			...
 			<section style="margin-top: 5%;">
	 			...
	 			<div class="list">
					<a style="display: block; width: 100%;" href="temperature_k_c.php">Kelvin (°K) --<i class="fa fa-angle-right"></i> Celsius (°C)</a>
	 			</div>
