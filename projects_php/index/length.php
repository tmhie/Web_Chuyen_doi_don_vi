		...
		<div id="left">
			...
			<section>
				<div style="font-size:20px;font-family: helvetica;">
					<b style="font-size: 25px;">Từ</b>: Inches  --<i class="fa fa-angle-right"></i> Millimeters 
				</div>
			</section><br>
			<section>
				<form method="post">
				<input type="number" name="inches" required="" min="0" value="1" style="width: 70%;height: 30px;">
			...
			<?php 
				if(isset($_POST['inches'])){
					...
					echo "<strong style ='font-size: 20px'> $inches inches = $millimeters millimeters </strong> ";
				}
 			?><br><br>
 			...
 			<section style="margin-top: 5%;">
	 			...
	 			<div class="list">
					<a style="display: block; width: 100%;" href="miles_kilometers.php">Miles --<i class="fa fa-angle-right"></i> Kilometers</a>
	 			</div>
