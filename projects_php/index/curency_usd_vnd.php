		...
		<div id="left">
			...
			<section>
				<div style="font-size:20px;font-family: helvetica;">
					<b style="font-size: 25px;">Từ</b>: USD (Đô la Mỹ)  --<i class="fa fa-angle-right"></i> VND (Việt Nam đồng) 
				</div>
			</section><br>
			<section>
				<form method="post">
			...
			<?php 
				...
				$USD = $_POST['USD'];
				$VND = $USD * 23.051 ;
				echo "<strong style ='font-size: 20px'> $USD USD = $VND VND </strong> ";
 			?>
 			<?php endif; ?> 			
 			...
 			<section style="margin-top: 5%;">
	 			<div class="list">
	 				<a style="display: block; width: 100%;" href="curency.php">USD (Đô la Mỹ) --<i class="fa fa-angle-right"></i> EUR (Euro)</a>
	 			</div><br>
	 			<div class="list">
