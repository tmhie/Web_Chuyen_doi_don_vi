		...
		<div id="left">
			...
			<section>
				<div style="font-size:20px;font-family: helvetica;">
					<b style="font-size: 25px;">Từ</b>: Square feet  --<i class="fa fa-angle-right"></i> Square meters 
				</div>
			</section><br>
			<section>
				<form method="post">
				<input type="number" name="square_feet" required="" min="0" value="1" style="width: 70%;height: 30px;">
				<input type="submit" value="Đổi" required="" style="height: 33px;width: 15%; margin-left: 20px;">
				</form>
			</section><br><br>
			<?php 
				if(isset($_POST['square_feet'])){
					$square_feet = $_POST['square_feet'];
					$square_meters = $square_feet * 10.764;
					echo "<strong style ='font-size: 20px'> $square_feet square feet = $square_meters square meters </strong> ";
				}
			?>
