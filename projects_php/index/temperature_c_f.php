		...
		<div id="left">
			...
			<section>
				<div style="font-size:20px;font-family: helvetica;">
					<b style="font-size: 25px;">Từ</b>: Celsius (°C)  --<i class="fa fa-angle-right"></i> Fahrenheit (°F)
				</div>
			</section><br>
			<section>
				<form method="post">
				<input type="number" name="Celsius" required="" min="0" value="1" style="width: 70%;height: 30px;">
			...
			<?php 
				...
				echo "<strong style ='font-size: 20px'> $Celsius Celsius = $Fahrenheit Fahrenheit </strong> ";
 			?>
 			<?php endif; ?>
