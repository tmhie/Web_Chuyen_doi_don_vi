		...
		<div id="left">
			...
			<section>
				<div style="font-size:20px;font-family: helvetica;">
					<b style="font-size: 25px;">Từ</b>: Cubic Yards  --<i class="fa fa-angle-right"></i> Cubic Meters 
				</div>
			</section><br>
			<section>
				<form method="post">
			...
			<?php
				...
				$p = $a *  0.764554858;
				echo "<strong style ='font-size: 20px'>$a Cubic Yards = $p Cubic Meters</strong>";
			?>
 			<?php endif; ?> 			
 			...
 			<section style="margin-top: 5%;">
	 			...
	 			<div class="list">
					<a style="display: block; width: 100%;" href="feet.php">Cubic Feet --<i class="fa fa-angle-right"></i>  Cubic Meters</a>
	 			</div>
