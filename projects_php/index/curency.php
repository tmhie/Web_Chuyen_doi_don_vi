...
<body>
	...
	<div id="main" class="row">
		<div id="left">
			<h1><i class="fa fa-money"></i> Chuyển đổi tiền tệ</h1><br>
			<section>
				<div style="font-size:20px;font-family: helvetica;">
					<b style="font-size: 25px;">Từ</b>: USD (Đô la Mỹ)  --<i class="fa fa-angle-right"></i> EUR (Euro) 
				</div>
			</section><br>
			<section>
				<form method="post">
				<input type="number" name="USD" required="" min="0" value="1" style="width: 70%;height: 30px;">
			...
			<?php 
				if(isset($_POST['USD'])):
				$USD = $_POST['USD'];
				$EUR = $USD * (23.320/24.742);
				echo "<strong style ='font-size: 20px'> $USD USD = $EUR EUR </strong> ";
 			?>
 			<?php endif; ?> 			
 			<section style="margin-top: 25%;">
 				<div style="font-size: 20px; font-family: arial;">
 					Chuyển đổi giữa các đơn vị <span style="text-decoration: underline; font-family: bold; font-size: 21px;">Tiền tệ</span> bằng cách sử dụng máy tính trực tuyến của chúng tôi.<br> Nhập bất kỳ số tiền nào bạn muốn chuyển đổi và nhấn nút Đổi.
 				</div>
 			</section>
 			<section style="margin-top: 5%;">
	 			<div class="list">
	 				<a style="display: block; width: 100%;" href="curency_gbp_usd.php">GBP (Bảng Anh) --<i class="fa fa-angle-right"></i> USD (Đô la Mỹ)</a>
	 			</div><br>
	 			<div class="list">
					<a style="display: block; width: 100%;" href="curency_usd_vnd.php">USD (Đô la Mỹ) --<i class="fa fa-angle-right"></i> VND (Việt Nam đồng)</a>
	 			</div><br>
	 			<div class="list">
					<a style="display: block; width: 100%;" href="curency_gbp_vnd.php">GBP (Bảng Anh) --<i class="fa fa-angle-right"></i> VND (Việt Nam đồng)</a>
	 			</div>
	 			<h1>Bảng ví dụ chuyển đổi</h1><br>
	 			<table border="1">
	 				<tr>
	 					<th rowspan="4" style="width: 130px;height: 80px">Tiền tệ</th>
	 					<td style="width: 500px;height: 40px; text-align: center;">1 USD (Đô la Mỹ) = 0.94253 EUR (Euro)</td>
	 				</tr>
	 				<tr>
   						<td style="width: 500px;height: 40px;text-align: center;">1 GBP (Bảng Anh) = 1.3086 USD (Đô la Mỹ)</td>
   					</tr>
   					<tr>
   						<td style="width: 500px;height: 40px;text-align: center;">1 USD (Đô la Mỹ) = 23.051 VND (Việt Nam đồng)</td>
   					</tr>
   					<tr>
   						<td style="width: 500px;height: 40px;text-align: center;">1 GBP (Bảng Anh) = 32.552 VND (Việt Nam đồng)</td>
   					</tr>
	 			</table>
 			</section>
		</div>
