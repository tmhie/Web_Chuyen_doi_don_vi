		...
		<div id="left">
			...
			<section>
				<div style="font-size:20px;font-family: helvetica;">
					<b style="font-size: 25px;">Từ</b>: Ounces (oz)  --<i class="fa fa-angle-right"></i> Grams (g)
				</div>
			</section><br>
			<section>
				<form method="post">
				<input type="number" name="Ounces" required="" min="0" value="1" style="width: 70%;height: 30px;">
				<input type="submit" value="Đổi" required="" style="height: 33px;width: 15%; margin-left: 20px;">
				</form>
			</section><br><br>
			<?php 
				if(isset($_POST['Ounces'])):
				$Ounces = $_POST['Ounces'];
				$Grams = $Ounces * 28.3495;
				echo "<strong style ='font-size: 20px'> $Ounces Ounces = $Grams Grams </strong> ";
 			?>
 			<?php endif; ?> 			
